...
export default function ImagePickerDummyPage() {
  ...
  return (
    ...
    >
      <Text className="text-xl text-center font-bold text-slate-900 dark:text-slate-50">Something went wrong.</Text>
      <Pressable className="p-3 mt-5 bg-slate-300 dark:bg-slate-600 rounded-lg">
        <Link className="text-xl font-bold text-slate-900 dark:text-slate-200" href="/">
